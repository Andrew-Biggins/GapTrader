...
namespace GapAnalyser.ViewModels
{
    ...
    public sealed class DynamicStrategyFinderViewModel : StrategyFinderViewModel
    {
        ...
        public DynamicStrategyFinderViewModel(GapFillStrategyTester strategyTester, IMarket market, IRunner runner) : base(strategyTester, market, runner)
        {
        ...
        public override void FindStrategies(StrategyTestFilters filters)
        {
            ...
            Balance = _selector.AccountSizer.AccountStartSize;
        ...
        private void AttemptStrategy(IGapFillStrategy strategy, DateTime currentDate)
        {
            ...
            dynamicTester.SetSizing(Balance, _selector.AccountSizer.RiskPercentage,
                _selector.AccountSizer.Compound);
